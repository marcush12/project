                  ...
                  ?>
    						...
    						<form id='registerform' class='form-horizontal' name='registerform' action="doRegister.php" method='post'>
    							<div class="form-group">
    								...
    								<div class="col-sm-10">
    									<input type="twxt" class='form-control' id='first_name' name='first_name' placeholder='First Name'>
    								</div>
    							</div>
    							<div class="form-group">
    							...
    							<div class="form-group">
    								...
    								<div class="col-sm-10">
    									<input type="email" class='form-control' id='verify_username' name='verify_username' placeholder='user@example.com'>
    								</div>
    							</div>
    							<div class="form-group">
